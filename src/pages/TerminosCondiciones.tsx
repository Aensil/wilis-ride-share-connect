          ...
          <div className="prose prose-slate max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">
                Wilis es una plataforma tecnológica de conexión (carpooling) que facilita el contacto 
                entre conductores particulares y pasajeros que desean compartir viajes entre Boyacá y Bogotá. 
                <strong className="text-foreground"> Funciones y limitaciones de Wilis:</strong>
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>Wilis NO es un servicio de transporte público, taxi, o transporte privado regulado</li>
                <li>Wilis NO es propietaria de los vehículos ni emplea a los conductores</li>
                <li>Los viajes son organizados directamente entre particulares (carpooling colaborativo)</li>
                <li>Wilis actúa exclusivamente como intermediario tecnológico para facilitar la comunicación</li>
                <li>Wilis no cobra comisiones por los viajes. El pago entre usuarios cubre únicamente gastos compartidos (gasolina, peajes)</li>
                <li>La responsabilidad del viaje recae 100% en el conductor del vehículo particular</li>
              </ul>
              <div className="mt-4 p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  <strong className="text-foreground">ADVERTENCIA LEGAL:</strong> Al usar Wilis, reconoces que viajas 
                  en un vehículo particular, no en transporte comercial. Wilis recomienda fuertemente verificar 
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-primary/10 border border-primary/20 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  ...
                  y puede resultar en suspensión permanente de Wilis más sanciones legales.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">
                <strong className="text-foreground">Wilis como plataforma tecnológica:</strong> Dado que Wilis 
                es únicamente una plataforma de conexión entre particulares y NO presta servicios de transporte, 
                Wilis limita su responsabilidad en los siguientes términos, sin perjuicio de las normas 
                imperativas de protección al consumidor (Ley 1480 de 2011):
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li><strong className="text-foreground">Accidentes de tránsito:</strong> Wilis no se responsabiliza por accidentes, lesiones, o muerte durante el viaje. La responsabilidad recae en el conductor del vehículo y su seguro SOAT/póliza privada</li>
                <li><strong className="text-foreground">Pérdidas y daños:</strong> Wilis no responde por pérdida, robo, o daño de equipaje, dispositivos, u otros bienes personales</li>
                <li><strong className="text-foreground">Incumplimientos entre usuarios:</strong> Wilis no media disputas sobre pagos, cancelaciones, o incumplimientos de acuerdos. Los usuarios resuelven directamente o acuden a autoridades competentes</li>
                <li><strong className="text-foreground">Veracidad de información:</strong> Wilis verifica documentación básica pero no garantiza la exactitud total de perfiles, calificaciones, o información proporcionada por usuarios</li>
                <li><strong className="text-foreground">Fallas mecánicas:</strong> Wilis no inspecciona vehículos físicamente. El conductor es responsable del estado mecánico</li>
                <li><strong className="text-foreground">Actos de terceros:</strong> Wilis no responde por robos, asaltos, o actos criminales cometidos por o contra usuarios durante viajes</li>
              </ul>
              <div className="mt-4 p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  <strong className="text-foreground">RESPONSABILIDAD DEL USUARIO:</strong> Al usar Wilis, aceptas 
                  que viajas bajo tu propio riesgo. Wilis no sustituye ni reemplaza seguros de viaje, SOAT, 
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">
                Wilis se reserva el derecho de suspender temporal o permanentemente, o eliminar cuentas 
              ...
              <p className="text-muted-foreground mt-3">
                ...
                apelar enviando evidencia a contacto@wilis.co dentro de 15 días hábiles. Wilis responderá en 10 días hábiles.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">
                En caso de conflictos o disputas relacionadas con el uso de Wilis:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li><strong className="text-foreground">Mediación de Wilis:</strong> Si no se resuelve, pueden solicitar mediación informal de Wilis vía WhatsApp o email. Wilis no es un árbitro vinculante pero puede facilitar comunicación</li>
                <li><strong className="text-foreground">Conciliación:</strong> Para disputas sobre servicios de Wilis (no entre usuarios), las partes acuerdan intentar conciliación ante centros de conciliación reconocidos en Colombia antes de acudir a tribunales</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li><strong className="text-foreground">Reporte a Wilis:</strong> Después de atender la emergencia, repórtanos vía WhatsApp con detalles (fecha, hora, ubicación, usuarios involucrados, número de reporte policial si aplica)</li>
              ...
              <div className="mt-4 p-4 bg-primary/10 border border-primary/20 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  <strong className="text-foreground">LÍNEA DE AYUDA WILIS:</strong> WhatsApp oficial disponible 
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>Wilis recomienda contratar seguro de viaje personal si viajas frecuentemente</li>
            ...
            <section>
              ...
              <ul className="list-none text-muted-foreground space-y-2 ml-4">
                ...
                <li>🏢 <strong className="text-foreground">Razón social:</strong> Wilis Colombia</li>
              </ul>
            ...
            <div className="mt-8 p-6 bg-muted border border-border rounded-lg">
              <p className="text-sm text-muted-foreground">
                ...
                Wilis, confirmas que has leído, entendido, y aceptas estos términos y condiciones en su totalidad. 
